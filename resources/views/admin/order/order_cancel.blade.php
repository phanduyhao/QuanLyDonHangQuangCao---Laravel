...
@section('contents')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold text-danger mb-4">{{ $title }}</h4>
        <div>
            <form class="form-search" method="GET" action="{{ route('orderCancel') }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12 d-flex align-items-center">
                            <div class="text-nowrap">
                                ...
                                <a href="{{ route('orderCancel') }}" class="btn btn-secondary rounded-pill ms-2">
                    ...
                    <tbody>
                        @forelse ($orders as $key => $order)
                            <tr class="text-danger">
                                ...
                                <td>{{ $order->rejection_reason ?? 'Không rõ' }}</td>
